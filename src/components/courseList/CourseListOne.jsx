...
export default function CourseListOne() {
    ...
    const {isAddedToCartCourses, addCourseToCart, fetchAllCourses} = useContextElement();
    ...
    useEffect(() => {
        ...
        fetchAllCourses(); // Re-fetch courses if this component loads
                                                    ...
                                                    <div className="row x-gap-20 y-gap-15 items-center pt-30">
                                                        ...
                                                        <div className="col-auto">
                                                            <div
                                                                ...
                                                                <div
                                                                    className="icon-bookmark text-20 text-purple-1"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
