    ...
    const routesForAuthenticatedOnly = [
        {
            ...
            children: [
                ...
                { path: "courses", element: <CourseListPage5 /> },
                ...
                { path: "lesson-single/:lessonId", element: <LessonSinglePage1 /> },
                ...
                { path: "about", element: <AboutPage1 /> },
                { path: "about-2", element: <AboutPage2 /> },
                { path: "contact", element: <ContactPage1 /> },
